    ...
    <div>
      ...
      <div className="container mb-2 flex mx-auto w-full items-center justify-center">
        <ul className="flex flex-col p-4">
          ...
          <input
            ref={title}
            className="mt-2 p-2  border border-gray-800 rounded-xl "
          ></input>
          <button
            onClick={saveTodo}
            className="w-24 py-1 text-white mx-auto mb-12 mt-2 bg-green-400 rounded-xl hover:bg-green-500 text-2xl float-right"
          >
            Save
          </button>
